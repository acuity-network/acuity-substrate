...
pub fn compact_code_unwrap() -> &'static [u8] {
    acuity_runtime::WASM_BINARY.expect(
...
pub const SPEC_VERSION: u32 = acuity_runtime::VERSION.spec_version;

pub const TRANSACTION_VERSION: u32 = acuity_runtime::VERSION.transaction_version;
...
pub fn construct_block(
    ...
    executor_call(env, "Core_initialize_block", &header.encode())
        .0
        .unwrap();
    ...
    let header = Header::decode(
        &mut &executor_call(env, "BlockBuilder_finalize_block", &[0u8; 0])
            .0
            .unwrap()[..],
    )
    .unwrap();
